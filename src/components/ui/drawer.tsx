...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto max-h-[92vh] flex-col rounded-t-[24px] border border-zinc-200 dark:border-zinc-800 bg-card shadow-ios-float focus:outline-none",
        className
      )}
      {...props}
    >
